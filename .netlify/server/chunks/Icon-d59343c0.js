...
const Icon = (0, import_index_a69eba8f.c)(($$result, $$props, $$bindings, slots) => {
  const state = {
    name: "",
    loading: null,
    destroyed: false
  ...
  const onLoad = (icon) => {
    ...
    const dispatch = (0, import_index_a69eba8f.i)();
    dispatch("load", { icon });
  };
  function loaded2() {
  }
  (0, import_index_a69eba8f.o)(() => {
  ...
  return `${data !== null ? `<svg${(0, import_index_a69eba8f.g)([(0, import_index_a69eba8f.h)(data.attributes)], {})}><!-- HTML_TAG_START -->${data.body}<!-- HTML_TAG_END --></svg>` : ``}`;
});
